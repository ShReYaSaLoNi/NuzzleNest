...
const Footer = () =>{
  return (
    <div>
    <Grid className="bg-black text-white text-center mt-10" container sx= {{bgcolor:"black", color:"white", py:3}} style={{paddingLeft:"40px"}}>
    ...
    <Grid className="text-white" container sx= {{bgcolor:"black", color:"white", py:1}} style={{paddingLeft:"75vw"}}>
